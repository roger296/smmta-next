...
export const SHIPPING_FAQ: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      'Yes — orders of 10+ spools of the same SKU get a discount applied at checkout. For larger volumes, email orders@filament.cleverdeals.net and we&rsquo;ll quote.',
  },
  {
    question: 'Can I change my order after placing it?',
    answer:
      'If your order hasn&rsquo;t shipped, email orders@filament.cleverdeals.net with your order number — we&rsquo;ll do our best to update it before it leaves the warehouse.',
  },
];
