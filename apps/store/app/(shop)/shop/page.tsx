 ...
 * changes need to surface immediately. The underlying API already has
 * its own cache headers; we trade a little per-request latency for
 * always-fresh storefronts.
 */
