...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Clothes Shop — Everyday Wear, Easy Sizes',
    description:
      'Friendly, simple clothing in real sizes. Reliable fit, fast UK delivery.',
  },
};
    ...
    <>
      ...
      <section className="space-y-6 border-b border-[var(--brand-border)] pb-16">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--brand-accent)]">
          Real sizes · Easy returns · Friendly UK shop
        </p>
        <h1
      ...
      >
        <div className="space-y-3">
          ...
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)' }}
          >
            Friendly clothes, fair prices, no faff.
          </h2>
        </div>
        <div className="space-y-4 text-base leading-relaxed text-[var(--brand-muted)]">
          <p>
            We stock everyday clothes from a small set of UK partners — t-shirts,
            polos, hoodies, joggers — in real sizes that fit real people.
          </p>
          <p>
            Easy returns, fair prices, no hype. The price you see is the price you
            pay. If something doesn't fit, send it back — we'll cover the postage.
          </p>
        </div>
      </section>
    </>
