 ...
 *
 * Adapted from the Filament Store policy (apps/store/app/legal/privacy).
 * Changes for the Clothes Shop:
 *   - our supplier partners are named as recipients: they need the delivery
...
export const metadata: Metadata = {
  ...
  description:
    'How the Clothes Shop collects, stores and uses your personal information, the lawful bases we rely on, how long we keep it, and your rights under UK GDPR.',
    ...
    >
      <LegalSection id="who" heading="1. Who we are">
        <p>
          ...
          of {LEGAL.legalEntity} (company number {LEGAL.companyNumber}), registered at{' '}
          {LEGAL.registeredAddress}. {LEGAL.legalEntity} is the data controller for the personal
          information described in this policy.
        </p>
        <p>
          Questions, requests or complaints about privacy should go to <ContactEmail />.
        </p>
      </LegalSection>
      ...
      <LegalSection id="what" heading="3. What we collect">
        ...
        <p>
          ...
          succeeded, and our supplier partners and delivery companies tell us the status of your
          parcel. We never receive or store your full card number.
        </p>
      </LegalSection>
      ...
      <LegalSection id="search" heading="5. On-site search">
        <p>
          Our search bar uses a third-party AI model to understand what you are looking for. Only the
          text of your search is sent to the model provider — we do not send your name, email
          address, IP address, order history or any other identifying information, and the search log
          we keep for cost monitoring contains no fields that could identify you.
        </p>
        <p>Please do not type personal or sensitive information into the search bar.</p>
      </LegalSection>
      ...
      <LegalSection id="sharing" heading="6. Who we share it with">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            our supplier partners, who pack and post your order: they receive the delivery name,
            address and phone number, and the items ordered;
          </li>
      ...
      <LegalSection id="retention" heading="8. How long we keep it">
        <p>
          ...
          for. Order and transaction records are kept for seven years to meet tax and accounting
          obligations, marketing consents until you withdraw them, and general enquiries for a
          shorter period. Information no longer needed is securely deleted.
        </p>
      </LegalSection>
      ...
      <LegalSection id="marketing" heading="10. Marketing">
        <p>
          ...
          <ContactEmail />. Withdrawing consent does not stop transactional messages about an order
          you have placed.
        </p>
      </LegalSection>
      ...
      <LegalSection id="rights" heading="11. Your rights">
        ...
        <p>
          Make a request by emailing <ContactEmail />. We will respond within one month. In most cases
          we provide the information free of charge; where a request is manifestly unfounded or
          excessive we may charge a reasonable fee or refuse it, and if we refuse we will explain why
      ...
      <LegalSection id="changes" heading="13. Changes to this policy">
        <p>
          ...
          and requests should be addressed to <ContactEmail />.
        </p>
      </LegalSection>
    </LegalPage>
  );
